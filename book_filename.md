...
x <- runif(10,0,10)
x
##  [1] 9.134407 4.918596 0.531421 1.003644 6.455899 6.988416 6.384329 8.228563
##  [9] 9.260044 7.286245
```
...
``` r
cut(x, breaks=5)
##  [1] (7.51,9.27]  (4.02,5.77]  (0.523,2.28] (0.523,2.28] (5.77,7.51] 
##  [6] (5.77,7.51]  (5.77,7.51]  (7.51,9.27]  (7.51,9.27]  (5.77,7.51] 
## Levels: (0.523,2.28] (2.28,4.02] (4.02,5.77] (5.77,7.51] (7.51,9.27]
```
...
##  [1] (8,10] (4,6]  (0,2]  (0,2]  (6,8]  (6,8]  (6,8]  (8,10] (8,10] (6,8] 
...
summary(df)
##        x                 y            
##  Min.   :-2.27610   Length:10         
##  1st Qu.:-1.06050   Class :character  
##  Median : 0.30285   Mode  :character  
##  Mean   :-0.07548                     
##  3rd Qu.: 0.91304                     
##  Max.   : 1.51446
```
...
##  $ x: num  0.9519 0.7966 1.5145 -0.0824 1.0172 ...
##  $ y: chr  "a" "b" "c" "d" ...
```
...
rbind(df, c(3,"a"))
##                      x y
## 1    0.951865616114816 a
## 2    0.796559325900671 b
## 3     1.51445853738435 c
## 4  -0.0824074220433526 d
## 5     1.01718250812626 e
## 6     -1.1055850812014 f
## 7    -1.33361556080029 g
## 8    0.688112627707816 h
## 9    -0.92524257570011 i
## 10   -2.27610395730637 j
## 11                   3 a
```
...
cbind(df,z=runif(10))
##              x y          z
## 1   0.95186562 a 0.41363217
## 2   0.79655933 b 0.67390962
## 3   1.51445854 c 0.56087537
## 4  -0.08240742 d 0.98249173
## 5   1.01718251 e 0.07566066
## 6  -1.10558508 f 0.79988454
## 7  -1.33361556 g 0.43929447
## 8   0.68811263 h 0.05346160
## 9  -0.92524258 i 0.34086837
## 10 -2.27610396 j 0.85388360
```
...
t(df)
##   [,1]          [,2]          [,3]          [,4]          [,5]         
## x " 0.95186562" " 0.79655933" " 1.51445854" "-0.08240742" " 1.01718251"
## y "a"           "b"           "c"           "d"           "e"          
##   [,6]          [,7]          [,8]          [,9]          [,10]        
## x "-1.10558508" "-1.33361556" " 0.68811263" "-0.92524258" "-2.27610396"
## y "f"           "g"           "h"           "i"           "j"
```
...
``` r
df$x
##  [1]  0.95186562  0.79655933  1.51445854 -0.08240742  1.01718251 -1.10558508
##  [7] -1.33361556  0.68811263 -0.92524258 -2.27610396
```
...
str(df)
## 'data.frame':	10 obs. of  2 variables:
##  $ x: num  -1.0809 0.0954 -1.8845 -2.3008 -0.4199 ...
##  $ y: chr  "a" "b" "c" "d" ...
```
...
str(df)
## 'data.frame':	10 obs. of  2 variables:
##  $ x: num  1.206 -0.8 -0.316 1.962 -0.634 ...
##  $ y: chr  "a" "b" "c" "d" ...
```
...
##  $ x: num [1:10] -1.585 0.715 -1.317 -1.546 -0.13 ...
##  $ y: chr [1:10] "a" "b" "c" "d" ...
```
...
##    time       X      Y      Z
##   <int>   <dbl>  <dbl>  <dbl>
## 1  2010 -0.386  -1.70  -3.95 
## 2  2011 -0.415   3.81  -0.810
## 3  2012  0.0190 -0.864  6.41 
## 4  2013 -0.815   3.06  -0.471
## 5  2014  1.02    2.81  -1.09
```
...
## 1 X     -0.386 -0.415  0.0190 -0.815   1.02
## 2 Y     -1.70   3.81  -0.864   3.06    2.81
## 3 Z     -3.95  -0.810  6.41   -0.471  -1.09
```
...
##   name  `2010` `2011`  `2012`
##   <chr>  <dbl>  <dbl>   <dbl>
## 1 a      1.90   0.168 -0.0657
## 2 b      1.50   0.478 -0.843 
## 3 c     -2.77   1.00  -0.183 
## 4 d     -0.124  1.09  -0.801 
## 5 e      0.690  1.51   1.18  
## 6 f     -0.515 -0.756 -0.0832
```
...
##   <chr> <dbl>   <dbl>  <dbl>
## 1 a      2010  1.90   0.384 
## 2 a      2011  0.168  0.286 
## 3 a      2012 -0.0657 0.237 
## 4 b      2010  1.50   0.351 
## 5 b      2011  0.478  0.0477
## 6 b      2012 -0.843  0.880
```
