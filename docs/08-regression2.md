...
## (Intercept) 10.93121    0.20875 52.3639 < 2.2e-16 ***
## x            2.16751    0.30229  7.1703 7.483e-13 ***
## wT          -1.04274    0.18304 -5.6968 1.221e-08 ***
## ---
...
## 1     98 107.806                                  
## 2     97  80.779  1    27.026 32.453 1.308e-07 ***
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
```
...
## (Intercept) 10.93121    0.22254 49.1194 < 2.2e-16 ***
## x            2.16751    0.31111  6.9669 3.904e-10 ***
## wT          -1.04274    0.18618 -5.6008 1.990e-07 ***
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
```
...
## 
##             Estimate Std. Error t value  Pr(>|t|)    
## (Intercept) 10.93121    0.21795 50.1544 < 2.2e-16 ***
## x            2.16751    0.30421  7.1250 1.843e-10 ***
## wT          -1.04274    0.18325 -5.6904 1.345e-07 ***
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
```
としなければならない.
...
## 
##             Estimate Std. Error z value  Pr(>|z|)    
## (Intercept) 10.34195    0.21708 47.6408 < 2.2e-16 ***
## x            2.29810    0.35125  6.5427 6.042e-11 ***
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
```
...
## 
## data:  fm1
## BP = 0.58221, df = 2, p-value = 0.7474
```
...
## 
## data:  fm1
## BP = 0.0037207, df = 2, p-value = 0.9981
```
