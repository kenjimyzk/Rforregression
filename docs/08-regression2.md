...
## (Intercept) 11.23417    0.21924 51.2417 < 2.2e-16 ***
## x            1.70471    0.32550  5.2373 1.629e-07 ***
## wT          -0.92112    0.19596 -4.7006 2.594e-06 ***
## ---
...
## 1     98 113.704                                  
## 2     97  92.609  1    21.095 22.096 8.574e-06 ***
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
```
...
## (Intercept) 11.23417    0.21123 53.1842 < 2.2e-16 ***
## x            1.70471    0.32174  5.2984 7.307e-07 ***
## wT          -0.92112    0.19854 -4.6394 1.094e-05 ***
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
```
...
## 
##             Estimate Std. Error t value  Pr(>|t|)    
## (Intercept) 11.23417    0.20685  54.311 < 2.2e-16 ***
## x            1.70471    0.31441   5.422 4.312e-07 ***
## wT          -0.92112    0.19561  -4.709 8.290e-06 ***
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
```
としなければならない.
...
## 
##             Estimate Std. Error z value  Pr(>|z|)    
## (Intercept) 10.71301    0.21041 50.9157 < 2.2e-16 ***
## x            1.77092    0.35071  5.0496 4.428e-07 ***
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
```
...
## 
## data:  fm1
## BP = 0.11174, df = 2, p-value = 0.9457
```
...
## 
## data:  fm1
## BP = 0.28357, df = 2, p-value = 0.8678
```
