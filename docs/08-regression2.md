...
## (Intercept) 10.87507    0.26220 41.4757 < 2.2e-16 ***
## x            1.85790    0.39562  4.6962 2.650e-06 ***
## wT          -0.86146    0.21809 -3.9501 7.813e-05 ***
## ---
...
## 1     98 127.23                                  
## 2     97 109.60  1     17.63 15.603 0.0001482 ***
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
```
...
## (Intercept) 10.87507    0.27381 39.7181 < 2.2e-16 ***
## x            1.85790    0.37666  4.9326 3.359e-06 ***
## wT          -0.86146    0.22448 -3.8375 0.0002213 ***
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
```
...
## 
##             Estimate Std. Error t value  Pr(>|t|)    
## (Intercept) 10.87507    0.26773 40.6193 < 2.2e-16 ***
## x            1.85790    0.36787  5.0505 2.068e-06 ***
## wT          -0.86146    0.22090 -3.8997 0.0001775 ***
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
```
としなければならない.
...
## 
##             Estimate Std. Error z value  Pr(>|z|)    
## (Intercept) 10.32089    0.25089 41.1370 < 2.2e-16 ***
## x            1.91628    0.40640  4.7153 2.414e-06 ***
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
```
...
## 
## data:  fm1
## BP = 0.64175, df = 2, p-value = 0.7255
```
