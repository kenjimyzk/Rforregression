...
## (Intercept) 10.65883    0.31636 33.6920 < 2.2e-16 ***
## x            2.74554    0.49855  5.5071 3.649e-08 ***
## wT          -0.55268    0.40997 -1.3481    0.1776    
## x:wT        -0.94381    0.68594 -1.3759    0.1688    
## ---
...
## 1     98 111.765                                  
## 2     96  83.234  2    28.531 16.453 7.175e-07 ***
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
```
...
## (Intercept) 10.65883    0.37488 28.4327 < 2.2e-16 ***
## x            2.74554    0.57525  4.7728 6.496e-06 ***
## wT          -0.55268    0.46726 -1.1828    0.2398    
## x:wT        -0.94381    0.74453 -1.2677    0.2080    
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
```
...
## 
##             Estimate Std. Error t value  Pr(>|t|)    
## (Intercept) 10.65883    0.35171 30.3054 < 2.2e-16 ***
## x            2.74554    0.54211  5.0646 1.977e-06 ***
## wT          -0.55268    0.44370 -1.2456    0.2159    
## x:wT        -0.94381    0.70821 -1.3327    0.1858    
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
```
...
## 
##             Estimate Std. Error z value  Pr(>|z|)    
## (Intercept) 10.22765    0.23358 43.7863 < 2.2e-16 ***
## x            2.57020    0.39072  6.5782 4.763e-11 ***
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
```
...
## (Intercept)  10.6588     0.3593  29.663 3.883e-50    9.946  11.3721 96
## x             2.7455     0.5526   4.968 2.941e-06    1.649   3.8425 96
## wT           -0.5527     0.4506  -1.227 2.230e-01   -1.447   0.3417 96
## x:wT         -0.9438     0.7186  -1.313 1.922e-01   -2.370   0.4826 96
## 
## Multiple R-squared:  0.4864 ,	Adjusted R-squared:  0.4703 
## F-statistic: 28.71 on 3 and 96 DF,  p-value: 2.443e-13
```
...
## Coefficients:
##             Estimate Std. Error t value  Pr(>|t|) CI Lower CI Upper DF
## (Intercept)  10.6588     0.3164  33.692 5.507e-55   10.031  11.2868 96
## x             2.7455     0.4985   5.507 3.045e-07    1.756   3.7352 96
## wT           -0.5527     0.4100  -1.348 1.808e-01   -1.366   0.2611 96
## x:wT         -0.9438     0.6859  -1.376 1.720e-01   -2.305   0.4178 96
## 
## Multiple R-squared:  0.4864 ,	Adjusted R-squared:  0.4703 
## F-statistic:  30.3 on 3 and 96 DF,  p-value: 7.16e-14
```
...
## 
## data:  fm1
## BP = 0.57319, df = 2, p-value = 0.7508
```
