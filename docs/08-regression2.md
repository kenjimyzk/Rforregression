...
## (Intercept) 10.62129    0.23558 45.0856 < 2.2e-16 ***
## x            2.17207    0.37082  5.8575 4.699e-09 ***
## wT          -0.54477    0.19956 -2.7299  0.006336 ** 
## ---
...
## 1     98 101.966                                
## 2     97  94.691  1    7.2747 7.4521 0.007526 **
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
```
...
## (Intercept) 10.62129    0.24283 43.7399 < 2.2e-16 ***
## x            2.17207    0.35542  6.1112 2.061e-08 ***
## wT          -0.54477    0.20312 -2.6820  0.008604 ** 
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
```
...
## 
##             Estimate Std. Error t value  Pr(>|t|)    
## (Intercept) 10.62129    0.23791 44.6437 < 2.2e-16 ***
## x            2.17207    0.34660  6.2667 1.017e-08 ***
## wT          -0.54477    0.20019 -2.7212  0.007711 ** 
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
```
としなければならない.
...
## 
##             Estimate Std. Error z value  Pr(>|z|)    
## (Intercept) 10.28750    0.21373 48.1321 < 2.2e-16 ***
## x            2.31200    0.35511  6.5107 7.478e-11 ***
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
```
