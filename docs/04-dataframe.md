...
x <- runif(10,0,10)
x
##  [1] 0.5496835 6.9013407 2.1860392 5.0273864 0.6955591 1.1782318 6.0076636
##  [8] 0.8093212 9.9687152 2.9683421
```
...
```r
cut(x, breaks=5)
##  [1] (0.54,2.43] (6.2,8.08]  (0.54,2.43] (4.32,6.2]  (0.54,2.43]
##  [6] (0.54,2.43] (4.32,6.2]  (0.54,2.43] (8.08,9.98] (2.43,4.32]
## Levels: (0.54,2.43] (2.43,4.32] (4.32,6.2] (6.2,8.08] (8.08,9.98]
```
...
##  [1] (0,2]  (6,8]  (2,4]  (4,6]  (0,2]  (0,2]  (6,8]  (0,2]  (8,10] (2,4] 
...
##  $ x: num  0.291 -0.845 -0.602 0.188 -1.29 ...
...
rbind(df, c(3,"a"))
##                     x y
## 1    0.29077666880564 a
## 2  -0.845356691287494 b
## 3  -0.601971449507506 c
## 4   0.187770704930986 d
## 5   -1.28958143243272 e
## 6  -0.173911008300472 f
## 7  -0.356143194977133 g
## 8  -0.962133489387323 h
## 9   0.294936624452919 i
## 10   1.49988693762945 j
## 11                  3 a
```
...
cbind(df,z=runif(10))
##             x y          z
## 1   0.2907767 a 0.78648298
## 2  -0.8453567 b 0.73705183
## 3  -0.6019714 c 0.05822252
## 4   0.1877707 d 0.90116240
## 5  -1.2895814 e 0.38281313
## 6  -0.1739110 f 0.67660555
## 7  -0.3561432 g 0.38534474
## 8  -0.9621335 h 0.71091259
## 9   0.2949366 i 0.96194052
## 10  1.4998869 j 0.81347461
```
...
t(df)
##   [,1]         [,2]         [,3]         [,4]         [,5]        
## x " 0.2907767" "-0.8453567" "-0.6019714" " 0.1877707" "-1.2895814"
## y "a"          "b"          "c"          "d"          "e"         
##   [,6]         [,7]         [,8]         [,9]         [,10]       
## x "-0.1739110" "-0.3561432" "-0.9621335" " 0.2949366" " 1.4998869"
## y "f"          "g"          "h"          "i"          "j"
```
...
```r
df$x
##  [1]  0.2907767 -0.8453567 -0.6019714  0.1877707 -1.2895814 -0.1739110
##  [7] -0.3561432 -0.9621335  0.2949366  1.4998869
```
