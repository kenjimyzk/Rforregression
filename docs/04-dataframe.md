...
x <- runif(10,0,10)
x
##  [1] 9.5052984 9.9451208 4.8396615 7.8603463 0.8904866 9.4346545 3.0588013
##  [8] 9.6566073 2.0350658 2.4182428
```
...
```r
cut(x, breaks=5)
##  [1] (8.13,9.95] (8.13,9.95] (4.51,6.32] (6.32,8.13] (0.881,2.7]
##  [6] (8.13,9.95] (2.7,4.51]  (8.13,9.95] (0.881,2.7] (0.881,2.7]
## Levels: (0.881,2.7] (2.7,4.51] (4.51,6.32] (6.32,8.13] (8.13,9.95]
```
...
##  [1] (8,10] (8,10] (4,6]  (6,8]  (0,2]  (8,10] (2,4]  (8,10] (2,4]  (2,4] 
...
##  $ x: num  1.109 0.216 0.018 0.265 -0.311 ...
...
rbind(df, c(3,"a"))
##                     x y
## 1    1.10949526203699 a
## 2   0.215980395482888 b
## 3     0.0179867214196 c
## 4   0.265352728117046 d
## 5  -0.310964240191004 e
## 6  -0.845455472168795 f
## 7   0.883999052688732 g
## 8   -0.15019563846802 h
## 9  0.0317252035476336 i
## 10  -1.66045439528029 j
## 11                  3 a
```
...
cbind(df,z=runif(10))
##              x y         z
## 1   1.10949526 a 0.3947800
## 2   0.21598040 b 0.3747994
## 3   0.01798672 c 0.7793312
## 4   0.26535273 d 0.4892319
## 5  -0.31096424 e 0.1849841
## 6  -0.84545547 f 0.5732967
## 7   0.88399905 g 0.3811647
## 8  -0.15019564 h 0.5618509
## 9   0.03172520 i 0.9923229
## 10 -1.66045440 j 0.1243024
```
...
t(df)
##   [,1]          [,2]          [,3]          [,4]          [,5]         
## x " 1.10949526" " 0.21598040" " 0.01798672" " 0.26535273" "-0.31096424"
## y "a"           "b"           "c"           "d"           "e"          
##   [,6]          [,7]          [,8]          [,9]          [,10]        
## x "-0.84545547" " 0.88399905" "-0.15019564" " 0.03172520" "-1.66045440"
## y "f"           "g"           "h"           "i"           "j"
```
...
```r
df$x
##  [1]  1.10949526  0.21598040  0.01798672  0.26535273 -0.31096424
##  [6] -0.84545547  0.88399905 -0.15019564  0.03172520 -1.66045440
```
