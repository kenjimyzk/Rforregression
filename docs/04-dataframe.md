...
x <- runif(10,0,10)
x
##  [1] 5.8543264 1.7558339 5.4369832 0.5314050 4.0641684 9.2777281 0.6861613
##  [8] 5.9110153 0.3719196 5.1658010
```
...
```r
cut(x, breaks=5)
##  [1] (5.72,7.5]   (0.363,2.15] (3.93,5.72]  (0.363,2.15] (3.93,5.72] 
##  [6] (7.5,9.29]   (0.363,2.15] (5.72,7.5]   (0.363,2.15] (3.93,5.72] 
## Levels: (0.363,2.15] (2.15,3.93] (3.93,5.72] (5.72,7.5] (7.5,9.29]
```
...
##  [1] (4,6]  (0,2]  (4,6]  (0,2]  (4,6]  (8,10] (0,2]  (4,6]  (0,2]  (4,6] 
...
summary(df)
##        x                 y            
##  Min.   :-0.80996   Length:10         
##  1st Qu.:-0.37685   Class :character  
##  Median : 0.04019   Mode  :character  
##  Mean   : 0.10730                     
##  3rd Qu.: 0.38805                     
##  Max.   : 1.30502
```
...
##  $ x: num  1.305 0.3655 -0.4625 0.0557 0.0247 ...
##  $ y: chr  "a" "b" "c" "d" ...
```
...
rbind(df, c(3,"a"))
##                     x y
## 1    1.30501871876649 a
## 2   0.365546687587815 b
## 3   -0.46246877967429 c
## 4  0.0556564300535692 d
## 5  0.0247183182409305 e
## 6    -0.1200057721757 f
## 7  -0.809960070710872 g
## 8  -0.573288442298967 h
## 9   0.395553964413319 i
## 10  0.892189026393222 j
## 11                  3 a
```
...
cbind(df,z=runif(10))
##              x y          z
## 1   1.30501872 a 0.31139552
## 2   0.36554669 b 0.00833534
## 3  -0.46246878 c 0.36093000
## 4   0.05565643 d 0.22324711
## 5   0.02471832 e 0.88023179
## 6  -0.12000577 f 0.08796891
## 7  -0.80996007 g 0.74511352
## 8  -0.57328844 h 0.35675028
## 9   0.39555396 i 0.25525104
## 10  0.89218903 j 0.96477289
```
...
t(df)
##   [,1]          [,2]          [,3]          [,4]          [,5]         
## x " 1.30501872" " 0.36554669" "-0.46246878" " 0.05565643" " 0.02471832"
## y "a"           "b"           "c"           "d"           "e"          
##   [,6]          [,7]          [,8]          [,9]          [,10]        
## x "-0.12000577" "-0.80996007" "-0.57328844" " 0.39555396" " 0.89218903"
## y "f"           "g"           "h"           "i"           "j"
```
...
```r
df$x
##  [1]  1.30501872  0.36554669 -0.46246878  0.05565643  0.02471832 -0.12000577
##  [7] -0.80996007 -0.57328844  0.39555396  0.89218903
```
