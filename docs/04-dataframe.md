...
x <- runif(10,0,10)
x
##  [1] 3.822533 2.106670 9.237566 2.315423 3.394052 8.685049 4.294849 3.336851
##  [9] 7.850624 1.676728
```
...
```r
cut(x, breaks=5)
##  [1] (3.19,4.7]  (1.67,3.19] (7.73,9.25] (1.67,3.19] (3.19,4.7]  (7.73,9.25]
##  [7] (3.19,4.7]  (3.19,4.7]  (7.73,9.25] (1.67,3.19]
## Levels: (1.67,3.19] (3.19,4.7] (4.7,6.21] (6.21,7.73] (7.73,9.25]
```
...
##  [1] (2,4]  (2,4]  (8,10] (2,4]  (2,4]  (8,10] (4,6]  (2,4]  (6,8]  (0,2] 
...
summary(df)
##        x                y            
##  Min.   :-1.5110   Length:10         
##  1st Qu.:-0.3495   Class :character  
##  Median : 0.3635   Mode  :character  
##  Mean   : 0.1471                     
##  3rd Qu.: 0.6553                     
##  Max.   : 1.2757
```
...
##  $ x: num  -0.581 0.53 -1.511 -0.499 0.697 ...
##  $ y: chr  "a" "b" "c" "d" ...
```
...
rbind(df, c(3,"a"))
##                     x y
## 1  -0.581202735409497 a
## 2   0.530327667695392 b
## 3   -1.51101015744487 c
## 4  -0.498986697099569 d
## 5   0.696925471138122 e
## 6   0.733516786433528 f
## 7   0.258456852333606 g
## 8   0.468530844254438 h
## 9    1.27565458741732 i
## 10 0.0988139623719478 j
## 11                  3 a
```
...
cbind(df,z=runif(10))
##              x y         z
## 1  -0.58120274 a 0.3569184
## 2   0.53032767 b 0.6924439
## 3  -1.51101016 c 0.3394345
## 4  -0.49898670 d 0.7589418
## 5   0.69692547 e 0.3089511
## 6   0.73351679 f 0.5062287
## 7   0.25845685 g 0.2152856
## 8   0.46853084 h 0.6330183
## 9   1.27565459 i 0.9069511
## 10  0.09881396 j 0.3503501
```
...
t(df)
##   [,1]          [,2]          [,3]          [,4]          [,5]         
## x "-0.58120274" " 0.53032767" "-1.51101016" "-0.49898670" " 0.69692547"
## y "a"           "b"           "c"           "d"           "e"          
##   [,6]          [,7]          [,8]          [,9]          [,10]        
## x " 0.73351679" " 0.25845685" " 0.46853084" " 1.27565459" " 0.09881396"
## y "f"           "g"           "h"           "i"           "j"
```
...
```r
df$x
##  [1] -0.58120274  0.53032767 -1.51101016 -0.49898670  0.69692547  0.73351679
##  [7]  0.25845685  0.46853084  1.27565459  0.09881396
```
