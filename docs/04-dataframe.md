...
x <- runif(10,0,10)
x
##  [1] 5.41099290 5.32447345 7.38350100 1.08993242 2.64735200 4.83328576
##  [7] 0.06447718 6.91360068 4.21488266 9.60779957
```
...
```r
cut(x, breaks=5)
##  [1] (3.88,5.79]   (3.88,5.79]   (5.79,7.7]    (0.0549,1.97] (1.97,3.88]  
##  [6] (3.88,5.79]   (0.0549,1.97] (5.79,7.7]    (3.88,5.79]   (7.7,9.62]   
## Levels: (0.0549,1.97] (1.97,3.88] (3.88,5.79] (5.79,7.7] (7.7,9.62]
```
...
##  [1] (4,6]  (4,6]  (6,8]  (0,2]  (2,4]  (4,6]  (0,2]  (6,8]  (4,6]  (8,10]
...
summary(df)
##        x                y            
##  Min.   :-1.3766   Length:10         
##  1st Qu.:-0.2595   Class :character  
##  Median : 0.2344   Mode  :character  
##  Mean   : 0.2161                     
##  3rd Qu.: 0.5821                     
##  Max.   : 2.3645
```
...
##  $ x: num  0.545 -1.377 0.595 2.365 -0.297 ...
##  $ y: chr  "a" "b" "c" "d" ...
```
...
rbind(df, c(3,"a"))
##                      x y
## 1     0.54452060189011 a
## 2    -1.37660999091827 b
## 3    0.594618697649301 c
## 4     2.36451961221601 d
## 5   -0.297240279996397 e
## 6    0.529924913871887 f
## 7    0.665756129747527 g
## 8  -0.0611402437041628 h
## 9   -0.146128825870164 i
## 10  -0.657424120620035 j
## 11                   3 a
```
...
cbind(df,z=runif(10))
##              x y          z
## 1   0.54452060 a 0.75461945
## 2  -1.37660999 b 0.94247040
## 3   0.59461870 c 0.22968150
## 4   2.36451961 d 0.56305336
## 5  -0.29724028 e 0.48222328
## 6   0.52992491 f 0.67580807
## 7   0.66575613 g 0.49661536
## 8  -0.06114024 h 0.70534282
## 9  -0.14612883 i 0.03143866
## 10 -0.65742412 j 0.01544733
```
...
t(df)
##   [,1]          [,2]          [,3]          [,4]          [,5]         
## x " 0.54452060" "-1.37660999" " 0.59461870" " 2.36451961" "-0.29724028"
## y "a"           "b"           "c"           "d"           "e"          
##   [,6]          [,7]          [,8]          [,9]          [,10]        
## x " 0.52992491" " 0.66575613" "-0.06114024" "-0.14612883" "-0.65742412"
## y "f"           "g"           "h"           "i"           "j"
```
...
```r
df$x
##  [1]  0.54452060 -1.37660999  0.59461870  2.36451961 -0.29724028  0.52992491
##  [7]  0.66575613 -0.06114024 -0.14612883 -0.65742412
```
