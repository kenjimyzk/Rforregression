...
x <- runif(10,0,10)
x
##  [1] 1.52089295 8.55585226 5.71958462 0.06558452 2.15219874 4.10808015
##  [7] 7.63052536 0.94735635 2.72808707 5.11737647
```
...
```r
cut(x, breaks=5)
##  [1] (0.0571,1.76] (6.86,8.56]   (5.16,6.86]   (0.0571,1.76] (1.76,3.46]  
##  [6] (3.46,5.16]   (6.86,8.56]   (0.0571,1.76] (1.76,3.46]   (3.46,5.16]  
## 5 Levels: (0.0571,1.76] (1.76,3.46] (3.46,5.16] ... (6.86,8.56]
```
...
##  [1] (0,2]  (8,10] (4,6]  (0,2]  (2,4]  (4,6]  (6,8]  (0,2]  (2,4]  (4,6] 
...
##  $ x: num  -0.786 -2.289 -0.077 -0.145 -0.139 ...
...
rbind(df, c(3,"a"))
##                      x y
## 1   -0.785759964380535 a
## 2    -2.28888243317969 b
## 3  -0.0770146001715059 c
## 4     -0.1454152045429 d
## 5   -0.139482608580019 e
## 6    -1.17447307059813 f
## 7    0.198055846282233 g
## 8    0.235170977898964 h
## 9    -1.17313543599885 i
## 10   0.914753576033812 j
## 11                   3 a
```
...
cbind(df,z=runif(10))
##             x y          z
## 1  -0.7857600 a 0.47612592
## 2  -2.2888824 b 0.39211144
## 3  -0.0770146 c 0.74205025
## 4  -0.1454152 d 0.14264309
## 5  -0.1394826 e 0.65106135
## 6  -1.1744731 f 0.08701001
## 7   0.1980558 g 0.84440229
## 8   0.2351710 h 0.39990231
## 9  -1.1731354 i 0.75497131
## 10  0.9147536 j 0.35305830
```
...
t(df)
##   [,1]         [,2]         [,3]         [,4]         [,5]        
## x "-0.7857600" "-2.2888824" "-0.0770146" "-0.1454152" "-0.1394826"
## y "a"          "b"          "c"          "d"          "e"         
##   [,6]         [,7]         [,8]         [,9]         [,10]       
## x "-1.1744731" " 0.1980558" " 0.2351710" "-1.1731354" " 0.9147536"
## y "f"          "g"          "h"          "i"          "j"
```
...
```r
df$x
##  [1] -0.7857600 -2.2888824 -0.0770146 -0.1454152 -0.1394826 -1.1744731
##  [7]  0.1980558  0.2351710 -1.1731354  0.9147536
```
