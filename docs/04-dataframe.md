...
x <- runif(10,0,10)
x
##  [1] 9.361774 3.126608 5.827158 1.118357 6.879558 1.121461 2.265842
##  [8] 9.886278 9.959547 4.428340
```
...
```r
cut(x, breaks=5)
##  [1] (8.19,9.97] (2.89,4.65] (4.65,6.42] (1.11,2.89] (6.42,8.19]
##  [6] (1.11,2.89] (1.11,2.89] (8.19,9.97] (8.19,9.97] (2.89,4.65]
## Levels: (1.11,2.89] (2.89,4.65] (4.65,6.42] (6.42,8.19] (8.19,9.97]
```
...
##  [1] (8,10] (2,4]  (4,6]  (0,2]  (6,8]  (0,2]  (2,4]  (8,10] (8,10] (4,6] 
...
##  $ x: num  -2.2472 0.0137 0.0238 -0.1324 -0.3497 ...
...
rbind(df, c(3,"a"))
##                     x y
## 1   -2.24721290824325 a
## 2  0.0136515732941203 b
## 3  0.0237530966281118 c
## 4  -0.132425910771446 d
## 5  -0.349722269898577 e
## 6   0.890873964202208 f
## 7   -1.67768892530833 g
## 8   0.520816047965951 h
## 9   -1.24894414070529 i
## 10  -1.02859430963018 j
## 11                  3 a
```
...
cbind(df,z=runif(10))
##              x y         z
## 1  -2.24721291 a 0.8174884
## 2   0.01365157 b 0.5353699
## 3   0.02375310 c 0.9737624
## 4  -0.13242591 d 0.6589592
## 5  -0.34972227 e 0.4715038
## 6   0.89087396 f 0.5793052
## 7  -1.67768893 g 0.7757221
## 8   0.52081605 h 0.9220106
## 9  -1.24894414 i 0.8332318
## 10 -1.02859431 j 0.2061127
```
...
t(df)
##   [,1]          [,2]          [,3]          [,4]          [,5]         
## x "-2.24721291" " 0.01365157" " 0.02375310" "-0.13242591" "-0.34972227"
## y "a"           "b"           "c"           "d"           "e"          
##   [,6]          [,7]          [,8]          [,9]          [,10]        
## x " 0.89087396" "-1.67768893" " 0.52081605" "-1.24894414" "-1.02859431"
## y "f"           "g"           "h"           "i"           "j"
```
...
```r
df$x
##  [1] -2.24721291  0.01365157  0.02375310 -0.13242591 -0.34972227
##  [6]  0.89087396 -1.67768893  0.52081605 -1.24894414 -1.02859431
```
