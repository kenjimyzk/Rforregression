...
x <- runif(10,0,10)
x
##  [1] 0.6002565 7.1202477 7.3062877 4.4099337 0.2801816 3.8162483 4.6366837
##  [8] 5.3834573 1.9026641 3.3375047
```
...
```r
cut(x, breaks=5)
##  [1] (0.273,1.69] (5.9,7.31]   (5.9,7.31]   (3.09,4.5]   (0.273,1.69]
##  [6] (3.09,4.5]   (4.5,5.9]    (4.5,5.9]    (1.69,3.09]  (3.09,4.5]  
## Levels: (0.273,1.69] (1.69,3.09] (3.09,4.5] (4.5,5.9] (5.9,7.31]
```
...
##  [1] (0,2] (6,8] (6,8] (4,6] (0,2] (2,4] (4,6] (4,6] (0,2] (2,4]
...
##  $ x: num  0.7568 0.0535 0.4546 -0.4678 1.8348 ...
...
rbind(df, c(3,"a"))
##                     x y
## 1   0.756822689912216 a
## 2  0.0534741970423275 b
## 3   0.454613285672429 c
## 4  -0.467797298191948 d
## 5    1.83478812851932 e
## 6   -1.30297576162984 f
## 7   0.490021509870791 g
## 8   0.455153782468816 h
## 9   0.811086466220496 i
## 10   1.08688276620874 j
## 11                  3 a
```
...
cbind(df,z=runif(10))
##             x y         z
## 1   0.7568227 a 0.1088986
## 2   0.0534742 b 0.4593324
## 3   0.4546133 c 0.7601716
## 4  -0.4677973 d 0.3224887
## 5   1.8347881 e 0.4229888
## 6  -1.3029758 f 0.5075946
## 7   0.4900215 g 0.2007510
## 8   0.4551538 h 0.4793684
## 9   0.8110865 i 0.9424509
## 10  1.0868828 j 0.7251940
```
...
t(df)
##   [,1]         [,2]         [,3]         [,4]         [,5]        
## x " 0.7568227" " 0.0534742" " 0.4546133" "-0.4677973" " 1.8347881"
## y "a"          "b"          "c"          "d"          "e"         
##   [,6]         [,7]         [,8]         [,9]         [,10]       
## x "-1.3029758" " 0.4900215" " 0.4551538" " 0.8110865" " 1.0868828"
## y "f"          "g"          "h"          "i"          "j"
```
...
```r
df$x
##  [1]  0.7568227  0.0534742  0.4546133 -0.4677973  1.8347881 -1.3029758
##  [7]  0.4900215  0.4551538  0.8110865  1.0868828
```
