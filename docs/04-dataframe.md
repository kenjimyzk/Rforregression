...
x <- runif(10,0,10)
x
##  [1] 7.8081872 3.5063431 1.0635085 1.8148186 8.4997836 0.7380885 2.9245283
##  [8] 6.0106348 8.5437458 8.4669064
```
...
```r
cut(x, breaks=5)
##  [1] (6.98,8.55] (2.3,3.86]  (0.73,2.3]  (0.73,2.3]  (6.98,8.55]
##  [6] (0.73,2.3]  (2.3,3.86]  (5.42,6.98] (6.98,8.55] (6.98,8.55]
## Levels: (0.73,2.3] (2.3,3.86] (3.86,5.42] (5.42,6.98] (6.98,8.55]
```
...
##  [1] (6,8]  (2,4]  (0,2]  (0,2]  (8,10] (0,2]  (2,4]  (6,8]  (8,10] (8,10]
...
##  $ x: num  0.491 0.3 0.115 0.65 0.41 ...
...
rbind(df, c(3,"a"))
##                     x y
## 1   0.490943395352449 a
## 2   0.299748202447566 b
## 3   0.114806257178259 c
## 4   0.649502102245656 d
## 5   0.410438313763549 e
## 6  -0.202900740808802 f
## 7  -0.561130102631628 g
## 8   -1.71274235640486 h
## 9   0.576120041175913 i
## 10  -1.47439114685888 j
## 11                  3 a
```
...
cbind(df,z=runif(10))
##             x y         z
## 1   0.4909434 a 0.9934267
## 2   0.2997482 b 0.4026853
## 3   0.1148063 c 0.6448435
## 4   0.6495021 d 0.5137529
## 5   0.4104383 e 0.4018903
## 6  -0.2029007 f 0.4960983
## 7  -0.5611301 g 0.5584948
## 8  -1.7127424 h 0.1320130
## 9   0.5761200 i 0.5540853
## 10 -1.4743911 j 0.9480326
```
...
t(df)
##   [,1]         [,2]         [,3]         [,4]         [,5]        
## x " 0.4909434" " 0.2997482" " 0.1148063" " 0.6495021" " 0.4104383"
## y "a"          "b"          "c"          "d"          "e"         
##   [,6]         [,7]         [,8]         [,9]         [,10]       
## x "-0.2029007" "-0.5611301" "-1.7127424" " 0.5761200" "-1.4743911"
## y "f"          "g"          "h"          "i"          "j"
```
...
```r
df$x
##  [1]  0.4909434  0.2997482  0.1148063  0.6495021  0.4104383 -0.2029007
##  [7] -0.5611301 -1.7127424  0.5761200 -1.4743911
```
