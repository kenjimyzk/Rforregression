...
x <- runif(10,0,10)
x
##  [1] 4.8397844 2.8710271 2.9436950 5.8783573 0.1000224 6.8496054 8.9576077
##  [8] 0.6301865 4.7405681 5.9573656
```
...
```r
cut(x, breaks=5)
##  [1] (3.64,5.41]   (1.87,3.64]   (1.87,3.64]   (5.41,7.19]   (0.0912,1.87]
##  [6] (5.41,7.19]   (7.19,8.97]   (0.0912,1.87] (3.64,5.41]   (5.41,7.19]  
## 5 Levels: (0.0912,1.87] (1.87,3.64] (3.64,5.41] ... (7.19,8.97]
```
...
##  [1] (4,6]  (2,4]  (2,4]  (4,6]  (0,2]  (6,8]  (8,10] (0,2]  (4,6]  (4,6] 
...
##  $ x: num  0.719 -0.43 0.799 -0.575 0.931 ...
...
rbind(df, c(3,"a"))
##                     x y
## 1    0.71861193914534 a
## 2  -0.429624851718038 b
## 3   0.799345462998909 c
## 4  -0.575361626368191 d
## 5   0.931057720822318 e
## 6  0.0312397397409619 f
## 7   0.981240100615073 g
## 8    1.51008429545827 h
## 9   0.977878410368489 i
## 10   -0.1657127742235 j
## 11                  3 a
```
...
cbind(df,z=runif(10))
##              x y         z
## 1   0.71861194 a 0.5184687
## 2  -0.42962485 b 0.8967534
## 3   0.79934546 c 0.5427406
## 4  -0.57536163 d 0.9366184
## 5   0.93105772 e 0.1203190
## 6   0.03123974 f 0.3816988
## 7   0.98124010 g 0.3898253
## 8   1.51008430 h 0.3343619
## 9   0.97787841 i 0.1568733
## 10 -0.16571277 j 0.5669304
```
...
t(df)
##   [,1]          [,2]          [,3]          [,4]          [,5]         
## x " 0.71861194" "-0.42962485" " 0.79934546" "-0.57536163" " 0.93105772"
## y "a"           "b"           "c"           "d"           "e"          
##   [,6]          [,7]          [,8]          [,9]          [,10]        
## x " 0.03123974" " 0.98124010" " 1.51008430" " 0.97787841" "-0.16571277"
## y "f"           "g"           "h"           "i"           "j"
```
...
```r
df$x
##  [1]  0.71861194 -0.42962485  0.79934546 -0.57536163  0.93105772
##  [6]  0.03123974  0.98124010  1.51008430  0.97787841 -0.16571277
```
