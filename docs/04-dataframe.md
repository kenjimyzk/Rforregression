...
x <- runif(10,0,10)
x
##  [1] 1.448061 1.242444 4.915462 9.978543 4.254607 7.279891 4.200208 6.039185
##  [9] 2.500370 5.594718
```
...
```r
cut(x, breaks=5)
##  [1] (1.23,2.99] (1.23,2.99] (4.74,6.48] (8.23,9.99] (2.99,4.74] (6.48,8.23]
##  [7] (2.99,4.74] (4.74,6.48] (1.23,2.99] (4.74,6.48]
## Levels: (1.23,2.99] (2.99,4.74] (4.74,6.48] (6.48,8.23] (8.23,9.99]
```
...
##  [1] (0,2]  (0,2]  (4,6]  (8,10] (4,6]  (6,8]  (4,6]  (6,8]  (2,4]  (4,6] 
...
summary(df)
##        x                 y            
##  Min.   :-2.13689   Length:10         
##  1st Qu.:-0.18124   Class :character  
##  Median : 0.06802   Mode  :character  
##  Mean   : 0.09098                     
##  3rd Qu.: 0.88183                     
##  Max.   : 1.17220
```
...
##  $ x: num  -0.117 0.645 -2.137 -0.203 -0.623 ...
##  $ y: chr  "a" "b" "c" "d" ...
```
...
rbind(df, c(3,"a"))
##                      x y
## 1   -0.117371107449346 a
## 2    0.645248484152778 b
## 3    -2.13689099747362 c
## 4    -0.20252323748115 d
## 5   -0.622591351453794 e
## 6     0.96068783648491 f
## 7     0.18707990088201 g
## 8     1.17220290346128 h
## 9  -0.0510397617056437 i
## 10    1.07501134031966 j
## 11                   3 a
```
...
cbind(df,z=runif(10))
##              x y         z
## 1  -0.11737111 a 0.1031385
## 2   0.64524848 b 0.5389381
## 3  -2.13689100 c 0.9485900
## 4  -0.20252324 d 0.1447809
## 5  -0.62259135 e 0.8960003
## 6   0.96068784 f 0.1418294
## 7   0.18707990 g 0.4087217
## 8   1.17220290 h 0.6284056
## 9  -0.05103976 i 0.2650579
## 10  1.07501134 j 0.8377570
```
...
t(df)
##   [,1]          [,2]          [,3]          [,4]          [,5]         
## x "-0.11737111" " 0.64524848" "-2.13689100" "-0.20252324" "-0.62259135"
## y "a"           "b"           "c"           "d"           "e"          
##   [,6]          [,7]          [,8]          [,9]          [,10]        
## x " 0.96068784" " 0.18707990" " 1.17220290" "-0.05103976" " 1.07501134"
## y "f"           "g"           "h"           "i"           "j"
```
...
```r
df$x
##  [1] -0.11737111  0.64524848 -2.13689100 -0.20252324 -0.62259135  0.96068784
##  [7]  0.18707990  1.17220290 -0.05103976  1.07501134
```
