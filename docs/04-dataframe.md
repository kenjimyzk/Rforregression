...
x <- runif(10,0,10)
x
##  [1] 5.9058286 0.5249434 5.4586889 0.6627498 8.6093477 6.5709411 6.4264165
##  [8] 6.2195446 9.1712291 7.4158020
```
...
```r
cut(x, breaks=5)
##  [1] (5.71,7.44]  (0.516,2.25] (3.98,5.71]  (0.516,2.25] (7.44,9.18] 
##  [6] (5.71,7.44]  (5.71,7.44]  (5.71,7.44]  (7.44,9.18]  (5.71,7.44] 
## 5 Levels: (0.516,2.25] (2.25,3.98] (3.98,5.71] ... (7.44,9.18]
```
...
##  [1] (4,6]  (0,2]  (4,6]  (0,2]  (8,10] (6,8]  (6,8]  (6,8]  (8,10] (6,8] 
...
##  $ x: num  1.7743 1.1472 -1.2096 1.6728 0.0209 ...
...
rbind(df, c(3,"a"))
##                     x y
## 1    1.77434795553126 a
## 2     1.1471975258253 b
## 3   -1.20958778890313 c
## 4    1.67282378419808 d
## 5  0.0208706728274986 e
## 6  -0.181136081749277 f
## 7   0.390423542274517 g
## 8    2.03394240632677 h
## 9   -1.04727074403668 i
## 10 -0.662833046995483 j
## 11                  3 a
```
...
cbind(df,z=runif(10))
##              x y         z
## 1   1.77434796 a 0.2857734
## 2   1.14719753 b 0.1158584
## 3  -1.20958779 c 0.5444381
## 4   1.67282378 d 0.9262948
## 5   0.02087067 e 0.4969209
## 6  -0.18113608 f 0.8618588
## 7   0.39042354 g 0.1092437
## 8   2.03394241 h 0.3379859
## 9  -1.04727074 i 0.1749621
## 10 -0.66283305 j 0.9641458
```
...
t(df)
##   [,1]          [,2]          [,3]          [,4]          [,5]         
## x " 1.77434796" " 1.14719753" "-1.20958779" " 1.67282378" " 0.02087067"
## y "a"           "b"           "c"           "d"           "e"          
##   [,6]          [,7]          [,8]          [,9]          [,10]        
## x "-0.18113608" " 0.39042354" " 2.03394241" "-1.04727074" "-0.66283305"
## y "f"           "g"           "h"           "i"           "j"
```
...
```r
df$x
##  [1]  1.77434796  1.14719753 -1.20958779  1.67282378  0.02087067
##  [6] -0.18113608  0.39042354  2.03394241 -1.04727074 -0.66283305
```
