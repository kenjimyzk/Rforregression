...
x <- runif(10,0,10)
x
##  [1] 1.05082841 1.88134190 6.82593460 3.12831128 5.32315532 4.40928165
##  [7] 0.02141198 0.81604068 3.30317761 5.53512618
```
...
```r
cut(x, breaks=5)
##  [1] (0.0146,1.38] (1.38,2.74]   (5.47,6.83]   (2.74,4.1]    (4.1,5.47]   
##  [6] (4.1,5.47]    (0.0146,1.38] (0.0146,1.38] (2.74,4.1]    (5.47,6.83]  
## Levels: (0.0146,1.38] (1.38,2.74] (2.74,4.1] (4.1,5.47] (5.47,6.83]
```
...
##  [1] (0,2] (0,2] (6,8] (2,4] (4,6] (4,6] (0,2] (0,2] (2,4] (4,6]
...
##  $ x: num  -0.4186 -0.6521 0.0885 2.0379 0.6366 ...
...
rbind(df, c(3,"a"))
##                     x y
## 1  -0.418636830277323 a
## 2   -0.65210886170229 b
## 3  0.0885337227077212 c
## 4    2.03792386390654 d
## 5   0.636649500827847 e
## 6   0.206167627053157 f
## 7   0.187783387293455 g
## 8   0.560667496336812 h
## 9  -0.134971793948274 i
## 10  0.326521235097829 j
## 11                  3 a
```
...
cbind(df,z=runif(10))
##              x y          z
## 1  -0.41863683 a 0.81229433
## 2  -0.65210886 b 0.62037902
## 3   0.08853372 c 0.32582848
## 4   2.03792386 d 0.79731535
## 5   0.63664950 e 0.49388888
## 6   0.20616763 f 0.53502057
## 7   0.18778339 g 0.03237084
## 8   0.56066750 h 0.54386170
## 9  -0.13497179 i 0.91279275
## 10  0.32652124 j 0.36104269
```
...
t(df)
##   [,1]          [,2]          [,3]          [,4]          [,5]         
## x "-0.41863683" "-0.65210886" " 0.08853372" " 2.03792386" " 0.63664950"
## y "a"           "b"           "c"           "d"           "e"          
##   [,6]          [,7]          [,8]          [,9]          [,10]        
## x " 0.20616763" " 0.18778339" " 0.56066750" "-0.13497179" " 0.32652124"
## y "f"           "g"           "h"           "i"           "j"
```
...
```r
df$x
##  [1] -0.41863683 -0.65210886  0.08853372  2.03792386  0.63664950
##  [6]  0.20616763  0.18778339  0.56066750 -0.13497179  0.32652124
```
