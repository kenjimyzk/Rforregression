...
x <- runif(10,0,10)
x
##  [1] 8.0137095 4.9718348 9.4554210 8.9686419 6.7449722 0.3560952 0.1480561
##  [8] 0.5147551 8.8347929 6.6466306
```
...
```r
cut(x, breaks=5)
##  [1] (7.59,9.46]  (3.87,5.73]  (7.59,9.46]  (7.59,9.46]  (5.73,7.59] 
##  [6] (0.139,2.01] (0.139,2.01] (0.139,2.01] (7.59,9.46]  (5.73,7.59] 
## Levels: (0.139,2.01] (2.01,3.87] (3.87,5.73] (5.73,7.59] (7.59,9.46]
```
...
##  [1] (8,10] (4,6]  (8,10] (8,10] (6,8]  (0,2]  (0,2]  (0,2]  (8,10] (6,8] 
...
summary(df)
##        x                 y            
##  Min.   :-1.31569   Length:10         
##  1st Qu.:-0.68973   Class :character  
##  Median : 0.07027   Mode  :character  
##  Mean   : 0.01967                     
##  3rd Qu.: 0.41055                     
##  Max.   : 2.08612
```
...
##  $ x: num  -1.2917 0.5136 0.0499 2.0861 0.0907 ...
##  $ y: chr  "a" "b" "c" "d" ...
```
...
rbind(df, c(3,"a"))
##                     x y
## 1   -1.29168082001772 a
## 2   0.513635741133564 b
## 3  0.0498795381846468 c
## 4    2.08612411565601 d
## 5  0.0906662956567243 e
## 6    1.05011161099398 f
## 7   -1.31569079284614 g
## 8   -0.25195838789794 h
## 9    0.10127357725885 i
## 10 -0.835648545214401 j
## 11                  3 a
```
...
cbind(df,z=runif(10))
##              x y          z
## 1  -1.29168082 a 0.61554215
## 2   0.51363574 b 0.03987113
## 3   0.04987954 c 0.10547684
## 4   2.08612412 d 0.50593614
## 5   0.09066630 e 0.66974976
## 6   1.05011161 f 0.51558900
## 7  -1.31569079 g 0.40658221
## 8  -0.25195839 h 0.36502222
## 9   0.10127358 i 0.77929785
## 10 -0.83564855 j 0.30248059
```
...
t(df)
##   [,1]          [,2]          [,3]          [,4]          [,5]         
## x "-1.29168082" " 0.51363574" " 0.04987954" " 2.08612412" " 0.09066630"
## y "a"           "b"           "c"           "d"           "e"          
##   [,6]          [,7]          [,8]          [,9]          [,10]        
## x " 1.05011161" "-1.31569079" "-0.25195839" " 0.10127358" "-0.83564855"
## y "f"           "g"           "h"           "i"           "j"
```
...
```r
df$x
##  [1] -1.29168082  0.51363574  0.04987954  2.08612412  0.09066630  1.05011161
##  [7] -1.31569079 -0.25195839  0.10127358 -0.83564855
```
