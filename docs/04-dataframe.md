...
x <- runif(10,0,10)
x
##  [1] 4.0564007 5.5833794 5.6231651 0.3840054 3.1518253 0.4619904 5.9262623
##  [8] 8.5702554 9.5137163 6.8144120
```
...
```r
cut(x, breaks=5)
##  [1] (4.04,5.86]  (4.04,5.86]  (4.04,5.86]  (0.375,2.21] (2.21,4.04] 
##  [6] (0.375,2.21] (5.86,7.69]  (7.69,9.52]  (7.69,9.52]  (5.86,7.69] 
## 5 Levels: (0.375,2.21] (2.21,4.04] (4.04,5.86] ... (7.69,9.52]
```
...
##  [1] (4,6]  (4,6]  (4,6]  (0,2]  (2,4]  (0,2]  (4,6]  (8,10] (8,10] (6,8] 
...
##  $ x: num  -1.823 -0.819 -1.425 0.704 -0.118 ...
...
rbind(df, c(3,"a"))
##                      x y
## 1    -1.82297898892015 a
## 2    -0.81913658482093 b
## 3    -1.42540447373858 c
## 4    0.703814332067238 d
## 5   -0.117653667984908 e
## 6   -0.505183820788922 f
## 7    -1.06431302765492 g
## 8  -0.0517255922518784 h
## 9   -0.160275539577823 i
## 10    1.36956452792766 j
## 11                   3 a
```
...
cbind(df,z=runif(10))
##              x y          z
## 1  -1.82297899 a 0.55199003
## 2  -0.81913658 b 0.92217421
## 3  -1.42540447 c 0.75168025
## 4   0.70381433 d 0.01536705
## 5  -0.11765367 e 0.26657226
## 6  -0.50518382 f 0.22429041
## 7  -1.06431303 g 0.64028738
## 8  -0.05172559 h 0.73353049
## 9  -0.16027554 i 0.87302406
## 10  1.36956453 j 0.39943805
```
...
t(df)
##   [,1]          [,2]          [,3]          [,4]          [,5]         
## x "-1.82297899" "-0.81913658" "-1.42540447" " 0.70381433" "-0.11765367"
## y "a"           "b"           "c"           "d"           "e"          
##   [,6]          [,7]          [,8]          [,9]          [,10]        
## x "-0.50518382" "-1.06431303" "-0.05172559" "-0.16027554" " 1.36956453"
## y "f"           "g"           "h"           "i"           "j"
```
...
```r
df$x
##  [1] -1.82297899 -0.81913658 -1.42540447  0.70381433 -0.11765367
##  [6] -0.50518382 -1.06431303 -0.05172559 -0.16027554  1.36956453
```
