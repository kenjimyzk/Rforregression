...
x <- runif(10,0,10)
x
##  [1] 9.9716416 9.6432430 6.3182389 3.9251566 0.4813137 4.3263559 3.1610214
##  [8] 9.7297733 1.7003799 4.8574238
```
...
```r
cut(x, breaks=5)
##  [1] (8.07,9.98]  (8.07,9.98]  (6.18,8.07]  (2.38,4.28]  (0.472,2.38]
##  [6] (4.28,6.18]  (2.38,4.28]  (8.07,9.98]  (0.472,2.38] (4.28,6.18] 
## Levels: (0.472,2.38] (2.38,4.28] (4.28,6.18] (6.18,8.07] (8.07,9.98]
```
...
##  [1] (8,10] (8,10] (6,8]  (2,4]  (0,2]  (4,6]  (2,4]  (8,10] (0,2]  (4,6] 
...
summary(df)
##        x                 y            
##  Min.   :-1.64679   Length:10         
##  1st Qu.:-0.42260   Class :character  
##  Median : 0.05842   Mode  :character  
##  Mean   : 0.09214                     
##  3rd Qu.: 0.48913                     
##  Max.   : 1.62573
```
...
##  $ x: num  0.5292 -0.0316 -1.6468 1.6096 1.6257 ...
##  $ y: chr  "a" "b" "c" "d" ...
```
...
rbind(df, c(3,"a"))
##                      x y
## 1    0.529182333513649 a
## 2  -0.0315997369610498 b
## 3    -1.64679432041891 c
## 4     1.60961330265654 d
## 5     1.62573362795361 e
## 6   -0.896094768908989 f
## 7    0.368966902128542 g
## 8   -0.333934890684549 h
## 9   -0.452152990398411 i
## 10   0.148440468746586 j
## 11                   3 a
```
...
cbind(df,z=runif(10))
##              x y          z
## 1   0.52918233 a 0.04714199
## 2  -0.03159974 b 0.26385727
## 3  -1.64679432 c 0.72808968
## 4   1.60961330 d 0.70629497
## 5   1.62573363 e 0.91945937
## 6  -0.89609477 f 0.25780499
## 7   0.36896690 g 0.99287124
## 8  -0.33393489 h 0.39191924
## 9  -0.45215299 i 0.51163227
## 10  0.14844047 j 0.07556467
```
...
t(df)
##   [,1]          [,2]          [,3]          [,4]          [,5]         
## x " 0.52918233" "-0.03159974" "-1.64679432" " 1.60961330" " 1.62573363"
## y "a"           "b"           "c"           "d"           "e"          
##   [,6]          [,7]          [,8]          [,9]          [,10]        
## x "-0.89609477" " 0.36896690" "-0.33393489" "-0.45215299" " 0.14844047"
## y "f"           "g"           "h"           "i"           "j"
```
...
```r
df$x
##  [1]  0.52918233 -0.03159974 -1.64679432  1.60961330  1.62573363 -0.89609477
##  [7]  0.36896690 -0.33393489 -0.45215299  0.14844047
```
