...
x <- runif(10,0,10)
x
##  [1] 5.9094809 5.2813438 4.0612017 8.6653366 0.9520723 5.4804830 8.9811002
##  [8] 9.5206193 1.4535274 0.1981737
```
...
```r
cut(x, breaks=5)
##  [1] (5.79,7.66]  (3.93,5.79]  (3.93,5.79]  (7.66,9.53]  (0.189,2.06]
##  [6] (3.93,5.79]  (7.66,9.53]  (7.66,9.53]  (0.189,2.06] (0.189,2.06]
## 5 Levels: (0.189,2.06] (2.06,3.93] (3.93,5.79] ... (7.66,9.53]
```
...
##  [1] (4,6]  (4,6]  (4,6]  (8,10] (0,2]  (4,6]  (8,10] (8,10] (0,2]  (0,2] 
...
##  $ x: num  1.007 1.21 -1.169 0.282 0.606 ...
...
rbind(df, c(3,"a"))
##                    x y
## 1   1.00715388758213 a
## 2   1.21016907764229 b
## 3  -1.16903705683675 c
## 4  0.281881092183758 d
## 5  0.606041580249505 e
## 6  0.408701098635692 f
## 7  0.886843125160037 g
## 8   0.86388589993127 h
## 9  0.568257605792262 i
## 10 0.619395572167557 j
## 11                 3 a
```
...
cbind(df,z=runif(10))
##             x y         z
## 1   1.0071539 a 0.1927828
## 2   1.2101691 b 0.9653780
## 3  -1.1690371 c 0.5475909
## 4   0.2818811 d 0.9585333
## 5   0.6060416 e 0.7454988
## 6   0.4087011 f 0.3836094
## 7   0.8868431 g 0.5838013
## 8   0.8638859 h 0.1817767
## 9   0.5682576 i 0.6241561
## 10  0.6193956 j 0.3604823
```
...
t(df)
##   [,1]         [,2]         [,3]         [,4]         [,5]        
## x " 1.0071539" " 1.2101691" "-1.1690371" " 0.2818811" " 0.6060416"
## y "a"          "b"          "c"          "d"          "e"         
##   [,6]         [,7]         [,8]         [,9]         [,10]       
## x " 0.4087011" " 0.8868431" " 0.8638859" " 0.5682576" " 0.6193956"
## y "f"          "g"          "h"          "i"          "j"
```
...
```r
df$x
##  [1]  1.0071539  1.2101691 -1.1690371  0.2818811  0.6060416  0.4087011
##  [7]  0.8868431  0.8638859  0.5682576  0.6193956
```
