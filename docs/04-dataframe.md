...
x <- runif(10,0,10)
x
##  [1] 2.180875 9.474309 7.413325 9.395008 6.021331 8.879978 4.493322
##  [8] 5.493958 3.778338 2.009900
```
...
```r
cut(x, breaks=5)
##  [1] (2,3.5]     (7.98,9.48] (6.49,7.98] (7.98,9.48] (5,6.49]   
##  [6] (7.98,9.48] (3.5,5]     (5,6.49]    (3.5,5]     (2,3.5]    
## Levels: (2,3.5] (3.5,5] (5,6.49] (6.49,7.98] (7.98,9.48]
```
...
##  [1] (2,4]  (8,10] (6,8]  (8,10] (6,8]  (8,10] (4,6]  (4,6]  (2,4]  (2,4] 
...
##  $ x: num  0.419 -0.713 -0.477 -0.933 -3.482 ...
...
rbind(df, c(3,"a"))
##                      x y
## 1    0.418700733421167 a
## 2   -0.712767857933726 b
## 3   -0.476858240917065 c
## 4   -0.933451370580552 d
## 5     -3.4820073330201 e
## 6   -0.839119485760245 f
## 7  -0.0607198649243853 g
## 8    -2.25093661965145 h
## 9   -0.864870930858021 i
## 10  -0.101613882366791 j
## 11                   3 a
```
...
cbind(df,z=runif(10))
##              x y          z
## 1   0.41870073 a 0.74762011
## 2  -0.71276786 b 0.50972781
## 3  -0.47685824 c 0.07916254
## 4  -0.93345137 d 0.67327459
## 5  -3.48200733 e 0.39688222
## 6  -0.83911949 f 0.19932462
## 7  -0.06071986 g 0.88068580
## 8  -2.25093662 h 0.71013799
## 9  -0.86487093 i 0.70481136
## 10 -0.10161388 j 0.68360377
```
...
t(df)
##   [,1]          [,2]          [,3]          [,4]          [,5]         
## x " 0.41870073" "-0.71276786" "-0.47685824" "-0.93345137" "-3.48200733"
## y "a"           "b"           "c"           "d"           "e"          
##   [,6]          [,7]          [,8]          [,9]          [,10]        
## x "-0.83911949" "-0.06071986" "-2.25093662" "-0.86487093" "-0.10161388"
## y "f"           "g"           "h"           "i"           "j"
```
...
```r
df$x
##  [1]  0.41870073 -0.71276786 -0.47685824 -0.93345137 -3.48200733
##  [6] -0.83911949 -0.06071986 -2.25093662 -0.86487093 -0.10161388
```
