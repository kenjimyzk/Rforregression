...
x <- runif(10,0,10)
x
##  [1] 1.443561 2.999219 9.046739 5.637666 2.550615 6.097331 5.105218 8.851351
##  [9] 1.895210 8.193143
```
...
```r
cut(x, breaks=5)
##  [1] (1.44,2.96] (2.96,4.48] (7.53,9.05] (4.48,6.01] (1.44,2.96] (6.01,7.53]
##  [7] (4.48,6.01] (7.53,9.05] (1.44,2.96] (7.53,9.05]
## Levels: (1.44,2.96] (2.96,4.48] (4.48,6.01] (6.01,7.53] (7.53,9.05]
```
...
##  [1] (0,2]  (2,4]  (8,10] (4,6]  (2,4]  (6,8]  (4,6]  (8,10] (0,2]  (8,10]
...
summary(df)
##        x                y            
##  Min.   :-1.8211   Length:10         
##  1st Qu.:-0.8941   Class :character  
##  Median :-0.3191   Mode  :character  
##  Mean   :-0.3703                     
##  3rd Qu.: 0.1738                     
##  Max.   : 0.8816
```
...
##  $ x: num  -0.64108 -0.74223 0.8816 -1.53391 0.00298 ...
##  $ y: chr  "a" "b" "c" "d" ...
```
...
rbind(df, c(3,"a"))
##                      x y
## 1   -0.641082882458816 a
## 2   -0.742233252997246 b
## 3    0.881600967228109 c
## 4     -1.5339062204693 d
## 5  0.00297957705669169 e
## 6   -0.944775892823111 f
## 7    0.766456445373466 g
## 8    0.182886306213283 h
## 9    0.146645506451525 i
## 10   -1.82109548811326 j
## 11                   3 a
```
...
cbind(df,z=runif(10))
##               x y          z
## 1  -0.641082882 a 0.02534730
## 2  -0.742233253 b 0.90940286
## 3   0.881600967 c 0.58143069
## 4  -1.533906220 d 0.35884777
## 5   0.002979577 e 0.44044359
## 6  -0.944775893 f 0.05242158
## 7   0.766456445 g 0.64775724
## 8   0.182886306 h 0.04097442
## 9   0.146645506 i 0.25467328
## 10 -1.821095488 j 0.71879023
```
...
t(df)
##   [,1]           [,2]           [,3]           [,4]           [,5]          
## x "-0.641082882" "-0.742233253" " 0.881600967" "-1.533906220" " 0.002979577"
## y "a"            "b"            "c"            "d"            "e"           
##   [,6]           [,7]           [,8]           [,9]           [,10]         
## x "-0.944775893" " 0.766456445" " 0.182886306" " 0.146645506" "-1.821095488"
## y "f"            "g"            "h"            "i"            "j"
```
...
```r
df$x
##  [1] -0.641082882 -0.742233253  0.881600967 -1.533906220  0.002979577
##  [6] -0.944775893  0.766456445  0.182886306  0.146645506 -1.821095488
```
