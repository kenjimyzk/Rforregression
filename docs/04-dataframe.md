...
x <- runif(10,0,10)
x
##  [1] 9.8839357 8.7395754 7.2404273 2.4169589 3.5503579 1.4191068 3.0370478
##  [8] 2.8548920 1.1761332 0.2737466
```
...
```r
cut(x, breaks=5)
##  [1] (7.96,9.89] (7.96,9.89] (6.04,7.96] (2.2,4.12]  (2.2,4.12] 
##  [6] (0.264,2.2] (2.2,4.12]  (2.2,4.12]  (0.264,2.2] (0.264,2.2]
## Levels: (0.264,2.2] (2.2,4.12] (4.12,6.04] (6.04,7.96] (7.96,9.89]
```
...
##  [1] (8,10] (8,10] (6,8]  (2,4]  (2,4]  (0,2]  (2,4]  (2,4]  (0,2]  (0,2] 
...
##  $ x: num  -1.3729 0.0366 -0.747 -1.1096 -0.6952 ...
...
rbind(df, c(3,"a"))
##                     x y
## 1   -1.37289093655622 a
## 2  0.0366032909981179 b
## 3  -0.746978473578673 c
## 4   -1.10955490699212 d
## 5   -0.69517859319539 e
## 6  -0.124590204946585 f
## 7  -0.845318556442115 g
## 8   0.360274563998319 h
## 9   -1.21839756624884 i
## 10 0.0246669092410717 j
## 11                  3 a
```
...
cbind(df,z=runif(10))
##              x y          z
## 1  -1.37289094 a 0.49132737
## 2   0.03660329 b 0.94045292
## 3  -0.74697847 c 0.45180111
## 4  -1.10955491 d 0.07557439
## 5  -0.69517859 e 0.32127580
## 6  -0.12459020 f 0.81237014
## 7  -0.84531856 g 0.22937289
## 8   0.36027456 h 0.23381878
## 9  -1.21839757 i 0.79467529
## 10  0.02466691 j 0.91252690
```
...
t(df)
##   [,1]          [,2]          [,3]          [,4]          [,5]         
## x "-1.37289094" " 0.03660329" "-0.74697847" "-1.10955491" "-0.69517859"
## y "a"           "b"           "c"           "d"           "e"          
##   [,6]          [,7]          [,8]          [,9]          [,10]        
## x "-0.12459020" "-0.84531856" " 0.36027456" "-1.21839757" " 0.02466691"
## y "f"           "g"           "h"           "i"           "j"
```
...
```r
df$x
##  [1] -1.37289094  0.03660329 -0.74697847 -1.10955491 -0.69517859
##  [6] -0.12459020 -0.84531856  0.36027456 -1.21839757  0.02466691
```
