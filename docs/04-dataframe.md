...
x <- runif(10,0,10)
x
##  [1] 9.692244 1.118645 9.771513 2.929681 7.132534 1.408130 1.670526 3.626161
##  [9] 2.569095 7.820375
```
...
```r
cut(x, breaks=5)
##  [1] (8.04,9.78] (1.11,2.85] (8.04,9.78] (2.85,4.58] (6.31,8.04] (1.11,2.85]
##  [7] (1.11,2.85] (2.85,4.58] (1.11,2.85] (6.31,8.04]
## Levels: (1.11,2.85] (2.85,4.58] (4.58,6.31] (6.31,8.04] (8.04,9.78]
```
...
##  [1] (8,10] (0,2]  (8,10] (2,4]  (6,8]  (0,2]  (0,2]  (2,4]  (2,4]  (6,8] 
...
summary(df)
##        x                y            
##  Min.   :-2.4594   Length:10         
##  1st Qu.:-0.2775   Class :character  
##  Median : 0.4049   Mode  :character  
##  Mean   : 0.2488                     
##  3rd Qu.: 0.9144                     
##  Max.   : 1.7500
```
...
##  $ x: num  0.855 -2.459 0.367 1.554 -0.751 ...
##  $ y: chr  "a" "b" "c" "d" ...
```
...
rbind(df, c(3,"a"))
##                    x y
## 1  0.855057703025133 a
## 2  -2.45940071486814 b
## 3  0.366602573674887 c
## 4   1.55439116868246 d
## 5  -0.75106233354302 e
## 6  0.934146242488109 f
## 7  0.247149619923987 g
## 8   1.75002128561049 h
## 9  -0.45232752749345 i
## 10 0.443159669856154 j
## 11                 3 a
```
...
cbind(df,z=runif(10))
##             x y         z
## 1   0.8550577 a 0.2660282
## 2  -2.4594007 b 0.1415574
## 3   0.3666026 c 0.3179230
## 4   1.5543912 d 0.1661038
## 5  -0.7510623 e 0.5945934
## 6   0.9341462 f 0.8267962
## 7   0.2471496 g 0.2902335
## 8   1.7500213 h 0.2279885
## 9  -0.4523275 i 0.1168382
## 10  0.4431597 j 0.4990337
```
...
t(df)
##   [,1]         [,2]         [,3]         [,4]         [,5]         [,6]        
## x " 0.8550577" "-2.4594007" " 0.3666026" " 1.5543912" "-0.7510623" " 0.9341462"
## y "a"          "b"          "c"          "d"          "e"          "f"         
##   [,7]         [,8]         [,9]         [,10]       
## x " 0.2471496" " 1.7500213" "-0.4523275" " 0.4431597"
## y "g"          "h"          "i"          "j"
```
...
```r
df$x
##  [1]  0.8550577 -2.4594007  0.3666026  1.5543912 -0.7510623  0.9341462
##  [7]  0.2471496  1.7500213 -0.4523275  0.4431597
```
