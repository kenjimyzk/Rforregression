...
x <- runif(10,0,10)
x
##  [1] 4.01373584 9.47863541 6.74394010 3.73434061 2.14600332 1.34173844
##  [7] 6.21174502 4.52197623 3.32021583 0.07347004
```
...
```r
cut(x, breaks=5)
##  [1] (3.84,5.72]   (7.6,9.49]    (5.72,7.6]    (1.95,3.84]   (1.95,3.84]  
##  [6] (0.0641,1.95] (5.72,7.6]    (3.84,5.72]   (1.95,3.84]   (0.0641,1.95]
## Levels: (0.0641,1.95] (1.95,3.84] (3.84,5.72] (5.72,7.6] (7.6,9.49]
```
...
##  [1] (4,6]  (8,10] (6,8]  (2,4]  (2,4]  (0,2]  (6,8]  (4,6]  (2,4]  (0,2] 
...
##  $ x: num  -1.311 0.457 -0.414 1.059 1.284 ...
...
rbind(df, c(3,"a"))
##                     x y
## 1   -1.31142100244258 a
## 2   0.457028987298136 b
## 3  -0.413601228300838 c
## 4    1.05945959467037 d
## 5    1.28357957730394 e
## 6    0.44685808669075 f
## 7    2.30726728270757 g
## 8  -0.202104556960736 h
## 9  -0.591913337240768 i
## 10   1.73073492739373 j
## 11                  3 a
```
...
cbind(df,z=runif(10))
##             x y          z
## 1  -1.3114210 a 0.43348670
## 2   0.4570290 b 0.16334923
## 3  -0.4136012 c 0.04082841
## 4   1.0594596 d 0.41048603
## 5   1.2835796 e 0.07216191
## 6   0.4468581 f 0.50385311
## 7   2.3072673 g 0.60514674
## 8  -0.2021046 h 0.10074220
## 9  -0.5919133 i 0.82346195
## 10  1.7307349 j 0.60352436
```
...
t(df)
##   [,1]         [,2]         [,3]         [,4]         [,5]        
## x "-1.3114210" " 0.4570290" "-0.4136012" " 1.0594596" " 1.2835796"
## y "a"          "b"          "c"          "d"          "e"         
##   [,6]         [,7]         [,8]         [,9]         [,10]       
## x " 0.4468581" " 2.3072673" "-0.2021046" "-0.5919133" " 1.7307349"
## y "f"          "g"          "h"          "i"          "j"
```
...
```r
df$x
##  [1] -1.3114210  0.4570290 -0.4136012  1.0594596  1.2835796  0.4468581
##  [7]  2.3072673 -0.2021046 -0.5919133  1.7307349
```
