...
##    time      X      Y     Z
##   <int>  <dbl>  <dbl> <dbl>
## 1  2010 -1.07  -0.497  9.42
## 2  2011  0.589  1.61   1.03
## 3  2012 -0.549  3.04  -3.29
## 4  2013  2.40  -1.48  -2.90
## 5  2014  0.167  2.82  -1.57
```
...
## 1 X     -1.07   0.589 -0.549   2.40  0.167
## 2 Y     -0.497  1.61   3.04   -1.48  2.82 
## 3 Z      9.42   1.03  -3.29   -2.90 -1.57
```
...
##   <chr>   <dbl>  <dbl>  <dbl>
## 1 a     -1.15   -0.923 -2.24 
## 2 b     -0.446  -0.820  0.736
## 3 c     -1.23    0.223 -0.645
## 4 d     -1.04   -3.20  -1.49 
## 5 e      0.0887  1.17   0.168
## 6 f      1.32    1.36   0.431
```
...
##   <chr> <dbl>   <dbl> <dbl>
## 1 a      2010 -1.15   0.411
## 2 b      2010 -0.446  0.709
## 3 c      2010 -1.23   0.712
## 4 d      2010 -1.04   0.879
## 5 e      2010  0.0887 0.718
## 6 f      2010  1.32   0.786
```
