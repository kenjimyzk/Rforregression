...
##    time      X     Y     Z
##   <int>  <dbl> <dbl> <dbl>
## 1  2010 -1.02  -1.04 -3.98
## 2  2011 -0.697  1.05 -8.38
## 3  2012 -0.189  1.91 -7.38
## 4  2013  2.76  -2.86 -1.81
## 5  2014  1.85  -1.02  1.98
```
...
## 1 X      -1.02 -0.697 -0.189   2.76   1.85
## 2 Y      -1.04  1.05   1.91   -2.86  -1.02
## 3 Z      -3.98 -8.38  -7.38   -1.81   1.98
```
...
##   name  `2010`  `2011`  `2012`
##   <chr>  <dbl>   <dbl>   <dbl>
## 1 a      0.241 -1.15    0.0152
## 2 b     -1.35   0.490  -1.13  
## 3 c     -0.196 -0.0114 -0.311 
## 4 d     -1.73   0.390   0.0446
## 5 e     -0.560  0.581  -0.537 
## 6 f      0.480 -0.440  -1.60
```
...
##   <chr> <dbl>  <dbl>  <dbl>
## 1 a      2010  0.241 0.0652
## 2 b      2010 -1.35  0.634 
## 3 c      2010 -0.196 0.530 
## 4 d      2010 -1.73  0.808 
## 5 e      2010 -0.560 0.921 
## 6 f      2010  0.480 0.0473
```
