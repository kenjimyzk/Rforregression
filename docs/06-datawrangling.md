...
##    time      X      Y      Z
##   <int>  <dbl>  <dbl>  <dbl>
## 1  2010  0.501 -0.970 -0.561
## 2  2011 -1.59   0.773  1.40 
## 3  2012 -0.305 -0.341  6.98 
## 4  2013 -0.897  1.99   4.37 
## 5  2014  0.886  1.98   1.49
```
...
## 1 X      0.501 -1.59  -0.305 -0.897  0.886
## 2 Y     -0.970  0.773 -0.341  1.99   1.98 
## 3 Z     -0.561  1.40   6.98   4.37   1.49
```
...
##   name  `2010` `2011`  `2012`
##   <chr>  <dbl>  <dbl>   <dbl>
## 1 a      0.505 -0.678 -1.28  
## 2 b      0.535 -0.739 -1.15  
## 3 c      0.804  1.22   0.659 
## 4 d      0.793  0.172  1.70  
## 5 e      1.12   0.519 -0.0510
## 6 f      0.231 -0.195  1.08
```
...
##   <chr> <dbl>  <dbl> <dbl>
## 1 a      2010  0.505 0.562
## 2 a      2011 -0.678 0.484
## 3 a      2012 -1.28  0.581
## 4 b      2010  0.535 0.578
## 5 b      2011 -0.739 0.425
## 6 b      2012 -1.15  0.789
```
