...
##    time       X     Y      Z
##   <int>   <dbl> <dbl>  <dbl>
## 1  2010  0.467   1.36 -0.540
## 2  2011  0.773  -1.63 -9.18 
## 3  2012 -0.0935  3.00 -1.01 
## 4  2013 -0.107  -1.56 -3.39 
## 5  2014 -0.219   1.81  2.91
```
...
## 1 X      0.467  0.773 -0.0935 -0.107 -0.219
## 2 Y      1.36  -1.63   3.00   -1.56   1.81 
## 3 Z     -0.540 -9.18  -1.01   -3.39   2.91
```
...
##   name  `2010` `2011` `2012`
##   <chr>  <dbl>  <dbl>  <dbl>
## 1 a     -0.787 -0.986 -0.194
## 2 b      0.236  0.646 -1.81 
## 3 c      0.857  0.965  1.19 
## 4 d     -0.741  0.669 -0.786
## 5 e     -2.04  -0.306 -0.204
## 6 f     -0.822  0.523  2.14
```
...
##   <chr> <dbl>  <dbl> <dbl>
## 1 a      2010 -0.787 0.454
## 2 b      2010  0.236 0.221
## 3 c      2010  0.857 0.449
## 4 d      2010 -0.741 0.623
## 5 e      2010 -2.04  0.524
## 6 f      2010 -0.822 0.664
```
