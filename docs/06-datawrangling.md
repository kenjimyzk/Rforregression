...
##    time       X      Y      Z
##   <int>   <dbl>  <dbl>  <dbl>
## 1  2010  0.0995 -0.133 -12.9 
## 2  2011  0.179  -1.69   -2.52
## 3  2012  0.248   1.42    3.89
## 4  2013 -0.198   1.28    2.52
## 5  2014  0.684   2.02    9.81
```
...
## 1 X       0.0995  0.179  0.248 -0.198  0.684
## 2 Y      -0.133  -1.69   1.42   1.28   2.02 
## 3 Z     -12.9    -2.52   3.89   2.52   9.81
```
...
##   name  `2010`   `2011` `2012`
##   <chr>  <dbl>    <dbl>  <dbl>
## 1 a      0.878 -0.421   -1.15 
## 2 b     -1.88   0.827   -2.50 
## 3 c      1.16  -0.0769   1.59 
## 4 d      2.46  -1.49     0.450
## 5 e      1.27   0.00806 -0.176
## 6 f      0.996 -0.652    0.532
```
...
##   <chr> <dbl>  <dbl>  <dbl>
## 1 a      2010  0.878 0.652 
## 2 b      2010 -1.88  0.775 
## 3 c      2010  1.16  0.0419
## 4 d      2010  2.46  0.399 
## 5 e      2010  1.27  0.924 
## 6 f      2010  0.996 0.149
```
