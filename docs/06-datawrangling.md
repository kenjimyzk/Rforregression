...
##    time           X          Y           Z
##   <int>       <dbl>      <dbl>       <dbl>
## 1  2010 -0.05261308  3.6498440  -2.9535008
## 2  2011 -1.52083830  0.6760293 -10.5043242
## 3  2012 -0.09800685 -1.7996858  -3.4035993
## 4  2013  1.75822523  0.4598567   0.1079268
## 5  2014 -0.72148428  0.1599653   1.2814736
```
...
##  8  2012     Y  -1.79968583
##  9  2013     Y   0.45985666
## 10  2014     Y   0.15996530
## 11  2010     Z  -2.95350084
## 12  2011     Z -10.50432425
## 13  2012     Z  -3.40359928
## 14  2013     Z   0.10792684
## 15  2014     Z   1.28147357
```
...
## 1     X -0.05261308  -1.5208383 -0.09800685 1.7582252 -0.7214843
## 2     Y  3.64984400   0.6760293 -1.79968583 0.4598567  0.1599653
## 3     Z -2.95350084 -10.5043242 -3.40359928 0.1079268  1.2814736
```
...
##  4     X  2011  -1.52083830
##  5     Y  2011   0.67602933
##  6     Z  2011 -10.50432425
##  7     X  2012  -0.09800685
##  8     Y  2012  -1.79968583
##  9     Z  2012  -3.40359928
## 10     X  2013   1.75822523
## 11     Y  2013   0.45985666
## 12     Z  2013   0.10792684
## 13     X  2014  -0.72148428
## 14     Y  2014   0.15996530
## 15     Z  2014   1.28147357
```
...
##    name     `2010`      `2011`     `2012`
##   <chr>      <dbl>       <dbl>      <dbl>
## 1     a -0.2128267 -0.44501466  0.1067670
## 2     b -1.5458802  1.28632472  1.8784916
## 3     c  0.2687649 -1.63671495  0.4498361
## 4     d  1.4305745 -0.90182356  1.0469801
## 5     e -0.3963176  0.09224267 -0.0613107
## 6     f  0.2679811  0.12068719  0.2628597
```
...
##    name       runif  time
##   <chr>       <dbl> <int>
## 1     a 0.081030443  2010
## 2     b 0.550720434  2010
## 3     c 0.695768167  2010
## 4     d 0.746665602  2010
## 5     e 0.007997954  2010
## 6     f 0.451930142  2010
```
それぞれの年の変数を付け加えている.
...
##   <chr> <dbl>      <dbl>       <dbl>
## 1     a  2010 -0.2128267 0.081030443
## 2     b  2010 -1.5458802 0.550720434
## 3     c  2010  0.2687649 0.695768167
## 4     d  2010  1.4305745 0.746665602
## 5     e  2010 -0.3963176 0.007997954
## 6     f  2010  0.2679811 0.451930142
```
