...
##    time     X      Y      Z
##   <int> <dbl>  <dbl>  <dbl>
## 1  2010 0.132 -0.433 -0.112
## 2  2011 1.29   1.34  -1.61 
## 3  2012 2.06   0.171  3.70 
## 4  2013 0.203  4.54   1.20 
## 5  2014 2.29  -1.70   0.135
```
...
## 1 X      0.132   1.29  2.06   0.203  2.29 
## 2 Y     -0.433   1.34  0.171  4.54  -1.70 
## 3 Z     -0.112  -1.61  3.70   1.20   0.135
```
...
##   <chr>   <dbl>  <dbl>   <dbl>
## 1 a      1.54   -0.281  2.32  
## 2 b      0.117  -1.60  -0.480 
## 3 c      0.722  -0.108 -2.47  
## 4 d      0.839  -0.952  0.0902
## 5 e     -0.0512 -0.102 -1.78  
## 6 f     -1.21    0.596  1.07
```
...
##   <chr> <dbl>  <dbl> <dbl>
## 1 a      2010  1.54  0.902
## 2 a      2011 -0.281 0.513
## 3 a      2012  2.32  0.168
## 4 b      2010  0.117 0.864
## 5 b      2011 -1.60  0.983
## 6 b      2012 -0.480 0.735
```
