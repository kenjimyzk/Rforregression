...
##    time      X      Y     Z
##   <int>  <dbl>  <dbl> <dbl>
## 1  2010  1.31  -1.73  -1.22
## 2  2011  0.567 -3.33  -6.29
## 3  2012 -0.227 -1.18  -3.33
## 4  2013  0.546 -0.657 -2.83
## 5  2014  0.109 -0.718  4.63
```
...
## 1 X       1.31  0.567 -0.227  0.546  0.109
## 2 Y      -1.73 -3.33  -1.18  -0.657 -0.718
## 3 Z      -1.22 -6.29  -3.33  -2.83   4.63
```
...
##   name  `2010` `2011`  `2012`
##   <chr>  <dbl>  <dbl>   <dbl>
## 1 a      0.885 -0.693 -1.27  
## 2 b      0.146 -0.495 -1.17  
## 3 c     -2.44  -0.999 -0.0362
## 4 d     -1.90   0.817  0.417 
## 5 e     -0.533  0.199 -1.47  
## 6 f      2.41  -0.407  2.13
```
...
##   <chr> <dbl>  <dbl> <dbl>
## 1 a      2010  0.885 0.400
## 2 b      2010  0.146 0.767
## 3 c      2010 -2.44  0.890
## 4 d      2010 -1.90  0.946
## 5 e      2010 -0.533 0.141
## 6 f      2010  2.41  0.748
```
