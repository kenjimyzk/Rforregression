...
##    time       X      Y      Z
##   <int>   <dbl>  <dbl>  <dbl>
## 1  2010  0.0360 -0.474 -3.07 
## 2  2011  0.475  -0.536 -1.85 
## 3  2012  0.498   0.503  4.72 
## 4  2013 -0.173  -2.56  -0.907
## 5  2014 -0.592  -1.76   1.97
```
...
## 1 X      0.0360  0.475  0.498 -0.173 -0.592
## 2 Y     -0.474  -0.536  0.503 -2.56  -1.76 
## 3 Z     -3.07   -1.85   4.72  -0.907  1.97
```
...
##   name  `2010`  `2011` `2012`
##   <chr>  <dbl>   <dbl>  <dbl>
## 1 a      1.91   0.314  -0.427
## 2 b      1.11   1.17    1.39 
## 3 c      0.241 -0.241   1.10 
## 4 d     -0.372 -0.0361  0.473
## 5 e      1.50  -0.190  -0.813
## 6 f      0.685  0.0928  1.18
```
...
##   <chr> <dbl>  <dbl> <dbl>
## 1 a      2010  1.91  0.438
## 2 a      2011  0.314 0.613
## 3 a      2012 -0.427 0.297
## 4 b      2010  1.11  0.955
## 5 b      2011  1.17  0.328
## 6 b      2012  1.39  0.129
```
